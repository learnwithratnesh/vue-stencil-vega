...
var platform = require('@stencil/core/platform');
var utils = require('@stencil/core/utils');
...
const createElm = (oldParentVNode, newParentVNode, childIndex, parentElm) => {
    ...
    if (buildConditionals.BUILD.vdomText && newVNode.$text$ !== null) {
        ...
        elm = newVNode.$elm$ = (buildConditionals.BUILD.isDebug || buildConditionals.BUILD.hydrateServerSide) ? platform.doc.createComment(`slot-reference:${hostTagName.toLowerCase()}`) : platform.doc.createTextNode('');
    }
    else {
