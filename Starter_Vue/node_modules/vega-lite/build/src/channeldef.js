...
import { getTimeUnitParts, normalizeTimeUnit, timeUnitToString, isLocalSingleTimeUnit } from './timeunit';
...
export function functionalTitleFormatter(fieldDef) {
    ...
    const fn = aggregate || ((_a = timeUnitParams) === null || _a === void 0 ? void 0 : _a.unit) || (((_b = timeUnitParams) === null || _b === void 0 ? void 0 : _b.maxbins) && 'timeunit') || (isBinning(bin) && 'bin');
    if (fn) {
...
export function valueArray(fieldDef, values) {
    var _a;
    const { type } = fieldDef;
    const timeUnit = (_a = normalizeTimeUnit(fieldDef.timeUnit)) === null || _a === void 0 ? void 0 : _a.unit;
    return values.map(v => {
