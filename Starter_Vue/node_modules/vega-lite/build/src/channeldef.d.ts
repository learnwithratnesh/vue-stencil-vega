...
export declare type ValueOrGradient = Value | Gradient;
export declare type ValueOrGradientOrText = Value | Gradient | Text;
/**
 ...
 */
export declare type ChannelDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradientOrText = Value> = FieldDefWithCondition<F, V> | ValueDefWithCondition<F, V>;
/**
 ...
 * @minProperties 1
 */
export declare type ValueDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradientOrText = Value> = Partial<ValueDef<V>> & {
    /**
...
export declare type ColorGradientValueDefWithCondition<F extends Field, T extends Type = StandardType> = ValueDefWithCondition<MarkPropFieldDef<F, T>, Gradient | string | null>;
...
export declare type TextValueDefWithCondition<F extends Field> = ValueDefWithCondition<StringFieldDef<F>, Text>;
 ...
 * }
 */
export declare type FieldDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradientOrText = Value> = F & ConditionValueDefMixins<V>;
export declare type ColorGradientFieldDefWithCondition<F extends Field, T extends Type = StandardType> = FieldDefWithCondition<MarkPropFieldDef<F, T>, Gradient | string | null>;
...
export declare type ShapeFieldDefWithCondition<F extends Field> = FieldDefWithCondition<MarkPropFieldDef<F, TypeForShape>, string | null>;
export declare type TextFieldDefWithCondition<F extends Field> = FieldDefWithCondition<StringFieldDef<F>, Text>;
export declare type StringFieldDefWithCondition<F extends Field> = FieldDefWithCondition<StringFieldDef<F>, string>;
/**
...
export declare function getBand(channel: Channel, fieldDef: FieldDef<string>, fieldDef2: ChannelDef<SecondaryFieldDef<string>>, mark: MarkDef, config: Config, { isMidPoint }?: {
    isMidPoint?: boolean;
}): number;
export declare function hasBand(channel: Channel, fieldDef: FieldDef<string>, fieldDef2: ChannelDef<SecondaryFieldDef<string>>, mark: MarkDef, config: Config): boolean;
/**
...
export declare type ChannelDef<FD extends FieldDef<any> = FieldDef<string>, V extends ValueOrGradientOrText = ValueOrGradientOrText> = ChannelDefWithCondition<FD, V>;
export declare function isConditionalDef<F extends Field, V extends ValueOrGradientOrText>(channelDef: ChannelDef<FieldDef<F>, V>): channelDef is ChannelDefWithCondition<FieldDef<F>, V>;
/**
 * Return if a channelDef is a ConditionalValueDef with ConditionFieldDef
 */
export declare function hasConditionalFieldDef<F extends Field, V extends ValueOrGradientOrText>(channelDef: ChannelDef<FieldDef<F>, V>): channelDef is Partial<ValueDef<V>> & {
    condition: Conditional<TypedFieldDef<F>>;
};
export declare function hasConditionalValueDef<F extends Field, V extends ValueOrGradient>(channelDef: ChannelDef<FieldDef<F>, V>): channelDef is ValueDef<V> & {
    condition: Conditional<ValueDef<V>> | Conditional<ValueDef<V>>[];
};
export declare function isFieldDef<F extends Field>(channelDef: ChannelDef<FieldDef<F>>): channelDef is TypedFieldDef<F> | SecondaryFieldDef<F> | PositionFieldDef<F> | ScaleFieldDef<F> | MarkPropFieldDef<F> | OrderFieldDef<F> | StringFieldDef<F>;
...
export declare function isValueDef<F extends Field, V extends ValueOrGradientOrText>(channelDef: ChannelDef<FieldDef<F>, V>): channelDef is ValueDef<V>;
...
export declare function isTextFieldDef<F extends Field>(channelDef: ChannelDef<FieldDef<F>>): channelDef is StringFieldDef<F>;
...
export declare function normalizeFieldDef(fd: FieldDef<string>, channel: Channel): {
    /**
     * __Required.__ A string defining the name of the field from which to pull a data value
     * or an object defining iterated values from the [`repeat`](https://vega.github.io/vega-lite/docs/repeat.html) operator.
     *
     ...
     * __See also:__ [`aggregate`](https://vega.github.io/vega-lite/docs/aggregate.html) documentation.
     */
    aggregate?: "count" | "min" | "max" | "average" | "distinct" | "mean" | "median" | "missing" | "q1" | "q3" | "ci0" | "ci1" | "stderr" | "stdev" | "stdevp" | "sum" | "valid" | "values" | "variance" | "variancep" | import("./aggregate").ArgminDef | import("./aggregate").ArgmaxDef | "boxplot" | "errorbar" | "errorband";
    /**
     * A flag for binning a `quantitative` field, [an object defining binning parameters](https://vega.github.io/vega-lite/docs/bin.html#params), or indicating that the data for `x` or `y` channel are binned before they are imported into Vega-Lite (`"binned"`).
     *
     * - If `true`, default [binning parameters](https://vega.github.io/vega-lite/docs/bin.html) will be applied.
    ...
    sort: {
        encoding: import("./sort").SortByChannel;
        order?: undefined;
    };
    /**
     * __Required.__ A string defining the name of the field from which to pull a data value
