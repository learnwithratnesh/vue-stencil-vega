...
export declare const BAR_CORNER_RADIUS_INDEX: {
    [orient in Orientation]: ('cornerRadiusTopLeft' | 'cornerRadiusTopRight' | 'cornerRadiusBottomLeft' | 'cornerRadiusBottomRight')[];
};
...
export interface MarkDef<M extends string | Mark = Mark> extends GenericMarkDef<M>, BarCornerRadiusMixins, RectBinSpacingMixins, MarkConfig, PointOverlayMixins, LineOverlayMixins, TickThicknessMixins, MarkDefMixins {
}
