import { Align, Axis as VgAxis, AxisEncode, AxisOrient, BaseAxis, Color, FontStyle, FontWeight, LabelOverlap, TextBaseline } from 'vega';
...
export declare type BaseAxisNoValueRefs = AxisMixins & ExcludeMappedValueRef<BaseAxis>;
...
export declare type ConditionalAxisProp = 'labelAlign' | 'labelBaseline' | 'labelColor' | 'labelFont' | 'labelFontSize' | 'labelFontStyle' | 'labelFontWeight' | 'labelOpacity' | 'labelPadding' | 'gridColor' | 'gridDash' | 'gridDashOffset' | 'gridOpacity' | 'gridWidth' | 'tickColor' | 'tickDash' | 'tickDashOffset' | 'tickOpacity' | 'tickSize' | 'tickWidth';
...
export declare type AxisConfigBaseWithConditional = Omit<BaseAxisNoValueRefs, ConditionalAxisProp> & {
...
export declare type AxisConfig = VlOnlyGuideConfig & AxisConfigBaseWithConditional;
