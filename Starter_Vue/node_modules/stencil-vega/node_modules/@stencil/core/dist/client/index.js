...
const supportsShadowDom = (buildConditionals.BUILD.shadowDom) ? /*@__PURE__*/ (() => (doc.head.attachShadow + '').indexOf('[native') > -1)() : false;
...
const patchEsm = () => {
    ...
    if (buildConditionals.BUILD.cssVarShim && !(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return new Promise(function (resolve) { resolve(require('./css-shim-910d4291.js')); }).then(() => {
...
const patchBrowser = () => {
    ...
    // @ts-ignore
    const scriptElm = Array.from(doc.querySelectorAll('script')).find(s => (new RegExp(`\/${buildConditionals.NAMESPACE}(\\.esm)?\\.js($|\\?|#)`).test(s.src) ||
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            ...
            // @ts-ignore
            return new Promise(function (resolve) { resolve(require('./dom-174aa71a.js')); }).then(() => opts);
        }
    }
