...
export declare class UnitModel extends ModelWithField {
    ...
    children: Model[];
    constructor(spec: NormalizedUnitSpec, parent: Model, parentGivenName: string, parentGivenSize: LayoutSizeMixins, repeater: RepeaterValue, config: Config);
    ...
    fieldDef(channel: SingleDefChannel): TypedFieldDef<string, import("../type").Type, boolean | import("../bin").BinParams | "binned">;
}
