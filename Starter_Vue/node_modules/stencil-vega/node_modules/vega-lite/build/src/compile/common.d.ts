...
export declare function getMarkPropOrConfig<P extends keyof MarkConfig>(channel: P, mark: MarkDef, config: Config): MarkConfig[P];
/**
...
export declare function getStyleConfig<P extends keyof AnyMarkConfig>(prop: P, mark: MarkDef, styleConfigIndex: StyleConfigIndex): any;
 ...
 */
export declare function timeFormatExpression(field: string, timeUnit: TimeUnit, format: string, rawTimeFormat: string, // should be provided only for actual text and headers, not axis/legend labels
...
export declare function mergeTitle(title1: Text, title2: Text): Text;
