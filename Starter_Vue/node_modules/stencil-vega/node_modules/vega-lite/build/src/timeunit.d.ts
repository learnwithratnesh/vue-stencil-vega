...
export declare type TimeFormatConfig = {
...
export declare function getTimeUnitSpecifierExpression(timeUnit: TimeUnit): string;
/**
...
export declare function correctTimeUnit(timeUnit: TimeUnit): TimeUnit;
