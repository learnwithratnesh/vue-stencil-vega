...
const NAMESPACE = 'stencil-starter-project-name';
...
const patchBrowser = () => {
    ...
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-7bdbc180.js', document.baseURI).href));
